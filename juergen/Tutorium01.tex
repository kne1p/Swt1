...
\item Besteht aus \textbf{Aktions-, Objekt- und Kontrollflussknoten} sowie \textbf{Objekt-} und \textbf{Kontrollflüssen}
\end{itemize}
...
fährt die Runde zu Ende. Wenn beim Überqueren der Start-/Ziellinie das Rennen nicht
abgewunken wurde, geht der Fahrer auf die nächste Runde, ansonsten ist das Rennen
beendet.
}
