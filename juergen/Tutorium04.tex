...
\frame {
\frametitle {Klausuraufgabe: Brücke und Beobachter}
...
Die Methode shade() in der Klasse FlatShaderDirectX implemen-tiert den Flat Shading-Algorithmus und verwendet die Methode draw(x:int, y:int, c:int), um einen Punkt unter Verwendung der DirectX-Programmierschnittstelle zu zeichnen

\includegraphics[scale=0.4]{pics/04/BrueckeA.png}
