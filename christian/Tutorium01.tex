...
\title[Tutorium 01]{Tutorium 01: Projektplanung }
\date{5. Mai 2011}
...
\begin{center}
\includegraphics[width=1\textwidth]{pics/01_checkstyle1}
\end{center}
}
\frame{
\frametitle{Eclipse - mehr Fehler anzeigen}
\begin{center}
\includegraphics[width=0.5\textwidth]{pics/01_checkstyle2}
\end{center}
}
\frame{
\frametitle{Eclipse - mehr Fehler anzeigen}
\begin{center}
\includegraphics[width=0.5\textwidth]{pics/01_checkstyle3}
\end{center}
}
...
\includegraphics[scale=0.5]{pics/01_Klassendiagramm-1.png}
}
\frame{
...
\begin{center}
\includegraphics[scale=0.5]{pics/01_Klassendiagramm.png}
\end{center}
}
...
\begin{center}
\includegraphics[scale=0.22]{pics/01_beispiel.png}
\end{center}
\end{exampleblock}
...
\frame{
\begin{center}
\includegraphics[scale=0.5]{pics/01_diagramm.png}
\end{center}
}
...
\begin{center}
\includegraphics[width=1\textwidth]{pics/01_time_management}
\end{center}
